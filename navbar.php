...
<style>
  ...
  <a class="navbar-brand" href="index.php">
    <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/restaurant-logo-template-design-deaa426a55e5dc6d4604fe46f2bb543a_screen.jpg?ts=1566606296" width="40" height="40" alt="logo">
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <?php if (isset($_SESSION['user'])) : ?>
        <li class="nav-item ">
          <a class="nav-link text-warning" href="clientOrders.php"><i class="fas fa-shopping-cart mr-2 text-warning"></i>View Orders</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-danger" href="logoutCustomer.php"><i class="fas fa-power-off mr-2 text-danger"></i>Logout</a>
        </li>
      <?php endif; ?>
    </ul>
    ...
    <div class="form-inline my-2 my-lg-0">
      ...
      <?php if (isset($_SESSION['user'])) : ?>
        <a href="ListItemCart.php" class="btn btn-outline-light my-2 my-sm-0">
          ...
          <span class="badge badge-danger ml-2"><?php echo isset($_SESSION['addedOrder']) ? count($_SESSION['addedOrder']) : ''; ?></span>
        </a>
    ...
    <!-- Notification Dropdown -->
        <div class="d-flex justify-content-between">
          <div class="dropdown mr-2">
              <button class="btn btn-outline-light" type="button" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php if (isset($_SESSION['user'])) : ?>
  <div class="welcome-customer">
    Welcome, <b><?php echo isset($_SESSION['customerName']) ? $_SESSION['customerName'] : 'Customer' ?></b>
  </div>
<?php endif; ?>
<script>
